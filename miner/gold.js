...
function init() {   
    ...
    bg.style.backgroundImage = "url(img/main.jpg)"//##########################################main#######################
    ...
    gameWords.innerHTML = '<h2>Welcome to our Gold Mine</h2>';
    gameWords.style.display = 'block';
    setTimeout('openWords()', 1000);   
}
function openWords() {
    gameWords.style.opacity = 0.9;
    setTimeout('closeWords()', 1000);   
}
function closeWords() {
    gameWords.style.opacity = 0;
    setTimeout('closeWordsWait()', 1000);    
}
...
gameHelp.onclick = function () {
    ...
    gameWords.innerHTML = '<br>Help<br><br>Single Mode：Use S or Down key<br> Double Mode：S key for first player, Down key for second player<br><br><br><div id = "back" style = "position: relative; ">Go Back</div>';
    gameWords.style.display = 'block';
...
gameAbout.onclick = function () {
    gameWords.innerHTML = '<br>About<br><br>This is a well-known classic game, Welcome to our playground! You can here enjoy our game alone in single mode, or with friend in dual mode. If you have some problems or opinion, Please let me know leaving your feedback!<br>Thank you! <br>Kimich^_^<br><br><br><div id = "back" style = "position: relative;">Go Back</div>';
    var name = document.getElementById('name');
    gameWords.style.lineHeight = '60px';
    gameWords.style.display = 'block';
    gameWords.style.opacity = 1;
...
function createLevel(level) {
    ...
    switch (level) {
        case 1: {
            bg.style.backgroundImage = "url(img/bg1.jpg)"; //#############################bg1#########################################
            goal = 700;
            ...
            break;
        case 2: {
            bg.style.backgroundImage = "url(img/bg2.jpg)"; //#################################bg2########################################3
            goal = 1700;
            gold_arr.splice(0, gold_arr.length);
            stone_arr.splice(0, stone_arr.length);
            mystery_arr.splice(0, mystery_arr.length);
            ...
            break;
        case 3: {
            bg.style.backgroundImage = "url(img/bg3.jpg)"; //#############################################bg3####################################
            goal = 2700;
            gold_arr.splice(0, gold_arr.length);
            stone_arr.splice(0, stone_arr.length);
            mystery_arr.splice(0, mystery_arr.length);
           ...
           // diamond_arr.push(new diamond(800, 400));
            ...
            break;
        case 4: {
            bg.style.backgroundImage = "url(img/bg4.jpg)"; //###########################################bg4#################################33
            goal = 3700;
            gold_arr.splice(0, gold_arr.length);
            stone_arr.splice(0, stone_arr.length);
            mystery_arr.splice(0, mystery_arr.length);
            ...
            break;
        case 5: {
            bg.style.backgroundImage = "url(img/bg5.jpg)"; //#################################bg5##################################
            goal =4700;
            gold_arr.splice(0, gold_arr.length);
            stone_arr.splice(0, stone_arr.length);
            mystery_arr.splice(0, mystery_arr.length);
            ...
            break;
        case 6: {
            bg.style.backgroundImage = "url(img/bg6.jpg)"; //###################################bg6################################3
            goal = 5700;
            gold_arr.splice(0, gold_arr.length);
            stone_arr.splice(0, stone_arr.length);
            mystery_arr.splice(0, mystery_arr.length);
            ...
            break;
        case 7: {
            bg.style.backgroundImage = "url(img/bg7.jpg)"; //##################################bg7######################################33
            goal = 6700;
            gold_arr.splice(0, gold_arr.length);
            stone_arr.splice(0, stone_arr.length);
            mystery_arr.splice(0, mystery_arr.length);
            ...
            break;
        case 8: {
            bg.style.backgroundImage = "url(img/bg8.jpg)"; //##########################################bg8##########################3
            goal =7700;
            gold_arr.splice(0, gold_arr.length);
            stone_arr.splice(0, stone_arr.length);
            mystery_arr.splice(0, mystery_arr.length);
            ...
            break;
        case 9: {
            bg.style.backgroundImage = "url(img/bg9.jpg)";//#############################################bg9#######################
            goal = 8700;
            gold_arr.splice(0, gold_arr.length);
            stone_arr.splice(0, stone_arr.length);
            mystery_arr.splice(0, mystery_arr.length);
            ...
            break;
        case 10: {
            bg.style.backgroundImage = "url(img/bg10.jpg)"; //#####################################bg10########################
            goal = 47000;
            gold_arr.splice(0, gold_arr.length);
            stone_arr.splice(0, stone_arr.length);
            mystery_arr.splice(0, mystery_arr.length);
...
function draw_all() {
    if (!in_shop) {
        ...
        if (isExploding == true) {
            ...
            bombExplode.src = "img/bombExplode.png";//################################################################BombExplde######################
...
function draw_bomb() {
    ...
    crackerImg.src = "img/cracker.png"; //############################cracker###################################################3
...
function enterShop() {//shop
    ...
    bg.style.backgroundImage = "url(img/shop.jpg)";//##########################################shop###############################
    // gameBoard.style.backgroundColor = '#8D8DD4';
...
gold.prototype = {
    ...
    draw: function () {
        ...
        goldImg.src = "img/gold.png";//######################################################gold##################################3
        if (this.size == 1)
...
stone.prototype = {
    ...
    draw: function () {
        ...
        stoneImg.src = "img/stone.png";//###################################################stone############################
        if (this.size == 1)
...
diamond.prototype = {
    ...
    draw: function () {
        ...
        diamondImg.src = "img/diamond.png";//####################################diamond###############################
...
clock.prototype = {
    ...
    draw: function () {
        ...
        clkImg.src = "img/clock.png";//############################################clock###################################3
        ctx.drawImage(clkImg, this.x - 25, this.y - 25, 50, 50);
    },
}
function mystery(x, y, size) {
    this.x = x;
    this.y = y;
    this.r = 25;
    this.moveSpeed = 0;
...
mystery.prototype = {
    ...
    draw: function () {
        ...
        mysteryImg.src = "img/mystery.png";//##############################################mystery###########################
...
bomb.prototype = {
    ...
    draw: function () {
        ...
        bombImg.src = "img/bomb.png";//########################################bomb#################################33
        var bombImgExplode = new Image();
        bombImgExplode.src = "img/bomb_remain.png";//############################bomb_remain##############################
...
flypig.prototype = {
    ...
    draw: function () {
        ...
        flypigImg.src = "img/flypig.png";//#######################################flypig##########################
        ctx.drawImage(flypigImg, this.x - 30, this.y - 25, 60, 50);
        if (this.diamond == 1) {
            var diaImg = new Image();
            diaImg.src = "img/diamond.png";//######################################diamond############################
...
player.prototype = {
    ...
    draw: function () {
        ...
        playerImg.src = "img/player.png";//##############################################player#################################
